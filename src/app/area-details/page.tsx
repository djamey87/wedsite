    ...
    <Container>
      <div className="px-20 pt-12">
        ...
        <p className="">
          ...
          location) and Lanusei (my hometown which is on the way to Arbatax from
          Olbia)
        </p>
        ...
        <ul className="list-disc">
          ...
          <li>
            ...
            <ul className="list-disc">
              <li>
                Visit the Bosco Selene (free parking), which includes kids park
                in the woods,{" "}
              ...
              <li>
                In Lanusei Village (free parking at Parcheggio di Piazza Mameli
                multistore parking, below the surface floor) take a walk in via
                Roma, if you are stopping there for a meal in the village I
                recommend. Ristorante Pizzeria Ka.Mi.Ste. alternatively La Nuova
                Verace ristorante Pizzeria, for an amazing gelato stop at Bar
                gelateria del Corso or for a drink you can visit also Nuovo
                Emporio Caffè. Before leaving, if you have time visit the view
                point called Santuario Madonna D' Ogliastra for a breath taking
                view of the coastline (free parking there).
              </li>
            </ul>
          </li>
        </ul>
