...
export default function Index() {
  ...
  return (
    <>
      <div className="flex flex-col items-center font-beyond hero-text center text-dm-grey justify-items-center bg-[url('/assets/images/header-image_home.jpg')] bg-opacity-20 rounded-xl overflow-hidden bg-center pt-8 pb-12">
